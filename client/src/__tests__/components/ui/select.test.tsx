...
describe("Select Component", () => {
  ...
  it("renders correctly with required props", () => {
    render(<Select name="test-select" options={mockOptions} />);
  ...
  it("renders empty option when hasEmpty is true", () => {
    render(<Select name="test-select" options={mockOptions} hasEmpty />);
  ...
  it("applies required attribute when required prop is true", () => {
    render(<Select name="test-select" options={mockOptions} required />);
